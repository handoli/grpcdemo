...
func (c *addServiceClient) Add(ctx context.Context, in *AddReq, opts ...grpc.CallOption) (*AddRes, error) {
	out := new(AddRes)
...
func (UnimplementedAddServiceServer) Add(context.Context, *AddReq) (*AddRes, error) {
